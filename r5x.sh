...
git clone --depth=1 https://github.com/eun0115/AnyKernel3.git -b r5x AnyKernel
...
function zipping() {
    cd AnyKernel || exit 1
    zip -r9 Nexus-v4-Revived-realme_r5x-${TANGGAL}.zip *
    cd ..
}
sendinfo
compile
